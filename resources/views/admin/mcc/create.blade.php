                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">MCC Add</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card-box">
                                    <form action="{{Route('mcc.store')}}" method="post" class="parsley-examples" novalidate="">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>MCC Branch Name<span class="text-danger">*</span></label>
                                                    <input type="text" name="branch_name" parsley-trigger="change" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="branch_code" parsley-trigger="change" required
                                                        placeholder="Enter Branch Code" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::select('mcci_id', $mcci, null, ['class' => 'form-control','data-toggle'=>'select2']) !!}
                                                </div>
                                            </div>
                                        </div>
